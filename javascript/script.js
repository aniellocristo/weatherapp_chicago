...
$.getJSON(api, function(data){
  ...
  var cTemp1 = data.current.temp_c;
  ...
  var cTempMax2 = data.forecast.forecastday[0].day.maxtemp_c;
  var fTempMin2 = data.forecast.forecastday[0].day.mintemp_f;
  var cTempMin2 = data.forecast.forecastday[0].day.mintemp_c;
  ...
  var cTempMax3 = data.forecast.forecastday[1].day.maxtemp_c;
  var fTempMin3 = data.forecast.forecastday[1].day.mintemp_f;
  var cTempMin3 = data.forecast.forecastday[1].day.mintemp_c;
  ...
  var cTempMax4 = data.forecast.forecastday[2].day.maxtemp_c;
  var fTempMin4 = data.forecast.forecastday[2].day.mintemp_f;
  var cTempMin4 = data.forecast.forecastday[2].day.mintemp_c;
  ...
  var cTempMax5 = data.forecast.forecastday[3].day.maxtemp_c;
  var fTempMin5 = data.forecast.forecastday[3].day.mintemp_f;
  var cTempMin5 = data.forecast.forecastday[3].day.mintemp_c;
...
//Assign information to day 4 html elements
  ...
  $("#tempc-min-5").html(Math.round(cTempMin5) + "&#8451;");

// Toggle for F to C
$(".tempbutton").click(function(){
      $(".tog-f").toggle().delay(400);
      $(".tog-c").toggle().delay(400);
});
